...
| Example | Shows |
|---------|-------|
| [`external-agent-json`](external-agent-json/) | How an outside agent can submit structured file actions through `mythos swd apply` |
...
- External-agent examples use structured file actions. Mythos validates paths, reviews risk, snapshots files, verifies disk state, rolls back failed writes, and records receipts for successful non-dry-run applies.
